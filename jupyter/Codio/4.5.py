...
if os.path.exists("/Users/erikborn/Documents/Python/jupyter/Codio/newAudio.wav"):
	os.remove("/Users/erikborn/Documents/Python/jupyter/Codio/newAudio.wav")

# Opens original audio file in a readable format
sound = wave.open("/Users/erikborn/Documents/Python/jupyter/Codio/guitarchords.wav", "rb")
...
samples = b''.join(data)
printMe = BitArray(hex = samples.hex())
# print(samples)
print(printMe.bin)

# sourceFile = open('/Users/erikborn/Documents/Python/jupyter/Codio/binary.txt', 'w')
# print(printMe, file = sourceFile)
# sourceFile.close()

# Creates a new audio file that is writeable
sound2 = wave.open("/Users/erikborn/Documents/Python/jupyter/Codio/newAudio.wav", "wb")
